    ...
    <div class="bg-white py-4">
        <div class="flex flex-col mx-6 my-2">
            ...
            <div class="flex flex-row">
                    <div class="text-lg text-gray-900 font-semibold p-2 mx-6">Customer Name: <br> {{ $order->name}}</div>
                    <div class="text-lg text-gray-900 font-semibold p-2 mx-6">Customer Location:<br>  {{ $order->location}}</div>
                    <div class="text-lg text-gray-900 font-semibold p-2 mx-6">Customer Phone:<br>  {{ $order->phone}}</div>
            </div>  
                ...
                <div class="mb-4 shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                  <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-accent-color">
                      <tr>
                        <th scope="col" class="px-6 py-3 text-left text-xs font-bold text-accent-color uppercase tracking-wider">
                          Id
                      </th>
                        <th scope="col" class="px-6 py-3 text-left text-xs font-bold text-accent-color uppercase tracking-wider">
                          Product Name
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                      ...
                      <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-black">{{ $product->created_at }}</div>
                          </td>
                      </tr>
                      @endforeach
