            ...
            @foreach ($courses as $course)
                <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <div class="p-4">
                        ...
                        <a href="#" class="inline-flex self-end w-fit items-center px-3 py-2 text-sm font-medium text-center text-light-color bg-primary-color rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                            Register
