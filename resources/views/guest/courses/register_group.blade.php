    ...
    <section class="course min-h-screen w-full p-2 flex items-center justify-center flex-col">
        ...
        <div class="flex flex-col sm:flex-row items-start justify-center p-4">
            ...
            <div class="w-full sm:w-1/2 p-4">
                ...
                <p class="mt-2 font-bold text-lg"><span class="text-primary-color">Estimated Price per Session per Person:</span> Ksh {{ $course->price }}/-</p>
            </div>   
        
        <fieldset id="group_form" class="flex flex-col items-start w-full sm:w-1/2 p-4 border-2 border-secondary-color rounded-md mt-4">
